...
// Source: github.com/leemingen1227/couple-server/worker (interfaces: TaskDistributor)
...
import (
	...
	worker "github.com/leemingen1227/couple-server/worker"
	reflect "reflect"
)
...
// DistributeTaskSendInvitationEmail mocks base method
func (m *MockTaskDistributor) DistributeTaskSendInvitationEmail(arg0 context.Context, arg1 *worker.PayloadSendInvitationEmail, arg2 ...asynq.Option) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "DistributeTaskSendInvitationEmail", varargs...)
	ret0, _ := ret[0].(error)
	return ret0
}

// DistributeTaskSendInvitationEmail indicates an expected call of DistributeTaskSendInvitationEmail
func (mr *MockTaskDistributorMockRecorder) DistributeTaskSendInvitationEmail(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DistributeTaskSendInvitationEmail", reflect.TypeOf((*MockTaskDistributor)(nil).DistributeTaskSendInvitationEmail), varargs...)
}
